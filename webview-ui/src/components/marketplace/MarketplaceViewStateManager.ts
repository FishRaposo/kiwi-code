 ...
 *
 * This class manages the state for the marketplace view in the Kiwi Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Kiwi Code extensions interface
