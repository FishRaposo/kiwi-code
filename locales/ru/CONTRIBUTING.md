...
### 3. Присоединяйся к сообществу Kiwi Code
...
- Для документации посетите [Документацию Kiwi Code](https://github.com/Zoo-Code-Org/Zoo-Code-Docs).
...
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/Zoo-Code-Org/Zoo-Code/issues/new/choose) с:
    ...
    - Версией Kiwi Code (обязательно); поставщиком/моделью ИИ, если применимо
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Kiwi Code.
