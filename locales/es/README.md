...
## ¿Qué puede hacer Kiwi Code por TI?
...
Kiwi Code se adapta a tu forma de trabajar, no al revés:
...
Más info: [Usar Modos](https://docs.kiwicode.dev/basic-usage/using-modes) • [Modos Personalizados](https://docs.kiwicode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.kiwicode.dev/tutorial-videos">Más tutoriales rápidos y vídeos de funcionalidades...</a>
</p>

## Recursos

- **[Documentación](https://docs.kiwicode.dev):** La guía oficial para instalar, configurar y dominar Kiwi Code.
...
Hay varias formas de ejecutar la extensión Kiwi Code:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión Kiwi Code en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/kiwi-code-<version>.vsix`).
