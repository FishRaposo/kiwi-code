...
# Đóng góp cho Kiwi Code

Kiwi Code là một dự án do cộng đồng điều khiển và chúng tôi vô cùng trân trọng mọi đóng góp. Để hợp lý hóa việc cộng tác, chúng tôi hoạt động trên cơ sở [Ưu tiên vấn đề](#cách-tiếp-cận-ưu-tiên-vấn-đề), có nghĩa là tất cả các [Yêu cầu kéo (PR)](#gửi-yêu-cầu-kéo) trước tiên phải được liên kết với một Vấn đề trên GitHub. Vui lòng xem kỹ hướng dẫn này.
...
### 3. Tham gia cộng đồng Kiwi Code
...
- Để biết tài liệu, hãy truy cập [Tài liệu Kiwi Code](https://github.com/Zoo-Code-Org/Zoo-Code-Docs).
...
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/Zoo-Code-Org/Zoo-Code/issues/new/choose) với:
    ...
    - Phiên bản Kiwi Code (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của Kiwi Code.
