...
### 3. Junte-se à comunidade do Kiwi Code
...
- Para documentação, visite [Documentação do Kiwi Code](https://github.com/Zoo-Code-Org/Zoo-Code-Docs).
...
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/Zoo-Code-Org/Zoo-Code/issues/new/choose) com:
    ...
    - Versão do Kiwi Code (obrigatório); provedor/modelo de IA, se relevante
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Kiwi Code.
